...
var ANCESTRY_FILE = "[\n  " + [
 ...
 //change it from JSON format to objects nested in an array
var ancestry = JSON.parse(ANCESTRY_FILE);
console.log(ancestry.length);
// console.log(ancestry);

//this is the resulting set of objects nested in arrays
var ancestry = [ { name: 'Carolus Haverbeke',
    sex: 'm',
    born: 1832,
    died: 1905,
...
//filter methods - returns the nested objects that match the critera.  The word potato can be anything - it's standing in there so that the it's really THIS OBJECT.father = THIS.  Returns the whole object
    // console.log(ancestry.filter(function(potato){
    //  return potato.father == "Carel Haverbeke";
    // }));
