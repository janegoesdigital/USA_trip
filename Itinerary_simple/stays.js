...
var addBookedTxt = function(){
 for (var i = 0; i < bookedArray.length; i ++) {
  ...
  var address = bookedArray[i].address;
  var bookedThrough = bookedArray[i].bookedThrough;
  var message =  city + ": you are staying at " + address + ". You will arrive on " + arrive + " and leave on " + leave + ". This has been booked through " + bookedThrough;
 var $p = $( "<p></p>" );
 $p.text(message);
 $('#booked').append($p);
  }
...
$('#stayCosts').text("The cost of accomodation is : AUD$ " + totalStayCosts + ".  ");
